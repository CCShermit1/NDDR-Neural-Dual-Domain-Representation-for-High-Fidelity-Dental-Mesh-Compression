...
__global__
void kernel_nddr_texture_fetch_forward
(
...
__global__
void kernel_nddr_texture_fetch_backward
(
...
torch::Tensor nddr_texture_fetch_forward
(
...
)
{
	...
	kernel_nddr_texture_fetch_forward <<< 64, 64 >>>
	(
...
torch::Tensor nddr_texture_fetch_backward
(
...
)
{
	...
	kernel_nddr_texture_fetch_backward <<< 64, 64 >>>
	(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
	...
	m.def("nddr_texture_fetch_forward", &nddr_texture_fetch_forward);
	m.def("nddr_texture_fetch_backward", &nddr_texture_fetch_backward);
}
